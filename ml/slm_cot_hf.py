...
MODELS = [
    {"name": "llama-3.1-8b", "provider": "hf", "model": "meta-llama/Llama-3.1-8B-Instruct"},
    # {"name": "mistral-7b", "provider": "hf", "model": "mistralai/Mistral-7B-Instruct-v0.3"},
    # {"name": "granite-3.3-2b", "provider": "hf", "model": "ibm-granite/granite-3.3-2b-instruct"},
]
...
if __name__ == "__main__":
    ...
    bandit = BanditLLM(
        ...
        top_p=TOP_P,
        prompt_mode="cot",
        plot_title_prefix="MovieLens",
    )

    bandit.run_all(
        users=USERS_DF.index.unique().to_list(),
        seed_text_fn=get_user_seed_movies,
